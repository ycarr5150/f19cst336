...
let randomSearch = ["flowers", "house", "season", "face", "cars"];
let rSNumber = Math.floor(Math.random() * 5);
console.log(rSNumber);
console.log(randomSearch[rSNumber]);

$.ajax({
    method: "GET",
    url: "https://pixabay.com/api/?key=5589438-47a0bca778bf23fc2e8c5bf3e&q=" + randomSearch[rSNumber],
    dataType: "json",
